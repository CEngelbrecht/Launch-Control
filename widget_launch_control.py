...
class LaunchControl(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.server_ip = self.settings['ip']
    ...
    def set_logging(self):
        print('Updating Logging')
        logname = time.strftime(self.settings['log_folder'] + "/LC_ClientLog(%H_%M_%S).log", time.localtime())
        logging.basicConfig(filename=logname, level=logging.DEBUG)
    ...
    def remake_socket(self):
        if self.connection_status:
            print('Closing Socket, Closing Existing Connection')
            self.s.close()
    ...
    def init_ui(self):
        ...
        self.timeup = self.settings['countdown_time']
        self.timert = QtWidgets.QLabel(self)
    ...
    def launch_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Launching at {}".format(time.asctime()))
            self.send_info('L')
    ...
    def read_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Reading at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
            ...
            self.logger.debug("Started Get Info Timer at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
    ...
    def ignite_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Igniting at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
            self.send_info('Ig')
        elif self.connection_status == False:
            QtWidgets.QMessageBox.information(self, 'Connection Results', 'You are not connected, please connect and try again.')
    ...
    def igniteoff_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Ignitor Off at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
            self.send_info('IO')
        elif self.connection_status == False:
            QtWidgets.QMessageBox.information(self, 'Connection Results', 'You are not connected, please connect and try again.')
    ...
    def boosterson_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Boosters On at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
            self.send_info('BL')
        elif self.connection_status == False:
            QtWidgets.QMessageBox.information(self, 'Connection Results', 'You are not connected, please connect and try again.')
    ...
    def boostersoff_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Boosters Off at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
            self.send_info('BO')
        elif self.connection_status == False:
            QtWidgets.QMessageBox.information(self, 'Connection Results', 'You are not connected, please connect and try again.')
    ...
    def abort_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Aborting at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
            self.send_info('A')
        elif self.connection_status == False:
            QtWidgets.QMessageBox.information(self, 'Connection Results', 'You are not connected, please connect and try again.')
    ...
    def connect_app(self):
        ...
        try:
            ...
            self.logger.debug("Connection Successful at {}".format(time.asctime()))

        except socket.error as e:
            self.logger.debug("Connection Unsuccessful at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
    ...
    def openvents_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Vents Opened at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
            self.send_info('VO')
        elif self.connection_status == False:
            QtWidgets.QMessageBox.information(self, 'Connection Results', 'You are not connected, please connect and try again.')
    ...
    def closevents_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Vents Closed at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
            self.send_info('VC')
        elif self.connection_status == False:
            QtWidgets.QMessageBox.information(self, 'Connection Results', 'You are not connected, please connect and try again.')
    ...
    def closemain_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Main Closed at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
            self.send_info('MC')
        elif self.connection_status == False:
            QtWidgets.QMessageBox.information(self, 'Connection Results', 'You are not connected, please connect and try again.')
    ...
    def hgpson_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("HGPS ON at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
    ...
    def hgpsoff_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("HGPS OFF at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
    ...
    def saftey_app(self):
        ...
        if self.connection_status == True:
            ...
            self.logger.debug("Connection Error, Safety will not toggle unless client is connected to server at {}".format(time.asctime()))
    ...
    def ping_app(self):
        ...
        #response = subprocess.call(["ping", self.server_ip,"-c1", "-W1","-q"])
        response = subprocess.call("ping {} -n 1 -w 1".format(self.server_ip)) #This is Windows syntax.
        self.logger.debug("Pinging Server at {}".format(time.asctime()))
        self.logTextBox.append("  >  Pinging Server{}".format(time.strftime("    -\t(%H:%M:%S)", time.localtime())))

        if response == 0:
            QtWidgets.QMessageBox.information(self, 'Ping Results', 'Ping to {} sucessful!\nGo ahead and connect.'.format(self.server_ip))
            self.logger.debug("Ping_Sucessful at {}".format(time.asctime()))
            self.logTextBox.append("  >  Pinging Successful{}".format(time.strftime(" -\t(%H:%M:%S)", time.localtime())))
        else:
            QtWidgets.QMessageBox.information(self, 'Ping Results', "Ping to {} unsucessful!\nCheck the IP you're connecting to, or if server is online.".format(self.server_ip))
            self.logger.debug("Ping_Unsucessful at {}".format(time.asctime()))
    ...
    def send_info(self,command):
        ...
        if command == 'MO':
            message = b'main_open'
            self.logger.debug("main_open at {}".format(time.asctime()))
        elif command == 'MC':
            message = b'main_close'
            self.logger.debug("main_close at {}".format(time.asctime()))
        elif command == 'VO':
            message = b'vents_open'
            self.logger.debug("vents_open at {}".format(time.asctime()))
        elif command == 'VC':
            message = b'vents_close'
            self.logger.debug("vents_close at {}".format(time.asctime()))
        elif command == 'L':
            message = b'launch'
            self.logger.debug("launch at {}".format(time.asctime()))
        elif command == 'A':
            message = b'abort'
            self.logger.debug("abort at {}".format(time.asctime()))
        elif command == "Ig":
            message = b"ign1_on"
            self.logger.debug("ign1_on at {}".format(time.asctime()))
        elif command == "IO":
            message = b"ign1_off"
            self.logger.debug("ign1_off at {}".format(time.asctime()))
        elif command =='HGPS_On':
            message = b"ign2_on"
            self.logger.debug("HGPS_On at {}".format(time.asctime()))
        elif command == 'HGPS_Off':
            message = b'ign2_off'
            self.logger.debug("HGPS_Off at {}".format(time.asctime()))
        elif command == "BL":
            message = b'boosters_lit'
            self.logger.debug("Boosters On at {}".format(time.asctime()))
        elif command == "BO":
            message = b'boosters_off'
            self.logger.debug("Boosters Off at {}".format(time.asctime()))
        ...
        if data.decode("utf-8") == 'Ignitor 1 Lit':
            ...
            self.logger.debug("Ignitor_1_lit at {}".format(time.asctime()))

        elif data.decode("utf-8") == 'Ignitor 1 Off':
            self.statusignitorred.setPixmap(QtGui.QPixmap('pictures/statred.png'))
            self.ignitorstatuschange.setText('Not Lit')
            self.logger.debug("Ignitor_1_Off at {}".format(time.asctime()))
            ...
            self.logger.debug("HGPS On at {}".format(time.asctime()))

        elif data.decode("utf-8") == 'Ignitor 2 Off':
            self.statushgpscolor.setPixmap(QtGui.QPixmap('pictures/statred.png'))
            self.hgpsstatuschange.setText('Off')
            self.logger.debug("HGPS Off at {}".format(time.asctime()))

        elif data.decode("utf-8") == 'Boosters Lit':
            #self.statushgpscolor.setPixmap(QtGui.QPixmap('pictures/statgreen.png'))
            #self.hgpsstatuschange.setText('On')
            self.logger.debug("Boosters Lit at {}".format(time.asctime()))
    ...
    def switch_label(self,label):
        ...
        if label == 'bwire':
            if self.breakwirechange.text() == 'Intact':
                ...
                self.logger.debug("bwire_Broken at {}".format(time.asctime()))
            elif self.breakwirechange.text() == 'Broken':
                self.statusbreakred.setPixmap(QtGui.QPixmap('pictures/statred.png'))
                self.breakwirechange.setText('Intact')
                self.logger.debug("bwire_Intact at {}".format(time.asctime()))
        ...
        if label == 'main':
            if self.mainValvechange.text() == 'Open':
                ...
                self.logger.debug("main_Closed at {}".format(time.asctime()))
        ...
        if label == 'kero':
            if self.keroValvechange.text() == 'Open':
                ...
                self.logger.debug("kero_Closed at {}".format(time.asctime()))
            elif self.keroValvechange.text() == 'Closed':
                self.statuskerored.setPixmap(QtGui.QPixmap('pictures/statred.png'))
                self.keroValvechange.setText('Open')
                self.logger.debug("kero_Open at {}".format(time.asctime()))
        ...
        if label == 'lox':
            if self.loxValvechange.text() == 'Open':
                ...
                self.logger.debug("lox_Closed at {}".format(time.asctime()))
            elif self.loxValvechange.text() == 'Closed':
                self.statusloxred.setPixmap(QtGui.QPixmap('pictures/statred.png'))
                self.loxValvechange.setText('Open')
                self.logger.debug("lox_Open at {}".format(time.asctime()))
    ...
    def get_info(self):
        ...
        try:
            ...
            self.logger.debug("{},{}".format(time_now,err))
        ...
        if self.bdata.decode("utf-8") != self.breakwirechange.text():
            ...
            print(self.bdata)
            self.logger.debug("bwire_status of {} at {}".format(str(self.bdata),time.asctime()))

        if self.mdata.decode("utf-8") != self.mainValvechange.text():
            self.switch_label('main')
            print("Main Changed")
            print(self.mdata)
            self.logger.debug("main_status of {} at {}".format(str(self.mdata),time.asctime()))

        if self.kdata.decode("utf-8") != self.keroValvechange.text():
            self.switch_label('kero')
            print("Kero Changed")
            print(self.kdata)
            self.logger.debug("kero_status of {} at {}".format(str(self.kdata),time.asctime()))

        if self.ldata.decode("utf-8") != self.loxValvechange.text():
            self.switch_label('lox')
            print("Lox Changed")
            print(self.ldata)
            self.logger.debug("lox_status of {} at {}".format(str(self.ldata),time.asctime()))
    ...
    def close_app(self):
        ...
        if choice == QtWidgets.QMessageBox.Yes:
            print("System Closed")
            self.logger.debug("Application Exited at {}".format(time.strftime("(%H:%M:%S)", time.localtime())))
            sys.exit()
        else:
